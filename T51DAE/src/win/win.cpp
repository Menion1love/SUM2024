...
tigl::win::~win( VOID ) 
{
  ...
  win::IsActive = FALSE;
} /* End of 'tigl::win::~win' function */

/* Window create function 
 * ARGUMENTS: None. 
 * RETURNS: None.
 */
VOID tigl::win::Create( VOID )    
{
  WNDCLASS wc;
...
} /* End of 'tigl::win::Create' function */

/* Full sreen function.
 * ARGUMENTS: None.
 * RETURNS: None.
 */
VOID tigl::win::FlipFullScreen( VOID )
{
  if (!IsFullScreen)
  {
    RECT rc;
...
} /* End of 'tigl::win::FlipFullScreen' function */
 ...
 */
LRESULT CALLBACK tigl::win::WinFunc( HWND hWnd, UINT Msg,
...
} /* End of 'tigl::win::WinFunc' function */
